(function () {
    angular.module('infotainment').controller('ImageGalarySliderCtrl', ImageGalarySliderCtrl);
...
//angular.module('infotainment').controller('ImageGalarySliderCtrl').animation('.slide-animation', function () {
//    return {
