...
namespace Infotainment.Data.Controls
{
    public class ImageDetailDb
    {
        ...
        public IEnumerable<IImageDetail> SelectInterNewsImageList(string NewsID)
        {
            ...
            {
                dbHelper.AddInParameter("@NewsID", NewsID, DbType.String);
                objDataReader = dbHelper.ExecuteDataReader(ProcedureName.SelectInterNewsImageDetail, CommandType.StoredProcedure);
        ...
        public IEnumerable<IImageDetail> StateNewsImageList(string NewsID)
        {
            ...
            {
                dbHelper.AddInParameter("@NewsID", NewsID, DbType.String);
                objDataReader = dbHelper.ExecuteDataReader(ProcedureName.StateNewsImageDetail, CommandType.StoredProcedure);
